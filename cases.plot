...
set xrange ["20200317":"20230115"]
set multiplot layout 2,1

set logscale y 10
set key top right
set title "Cases"
plot 'interpolated.csv' using 1:4 title "Smoothed New" with lines

unset logscale y
set nokey
set title "R-value"
unset ylabel
plot 'interpolated.csv' using 1:6 title "Smoothed R" with lines
